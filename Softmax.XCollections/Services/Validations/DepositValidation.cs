...
{
    public class DepositValidation : IDepositValidation
    {
        private ValidationResult validationResult;
        
        public ValidationResult ValidateCreate(DepositModel model)
        {
        ...
        public ValidationResult ValidateUpdate(DepositModel model)
        {
            this.validationResult = new ValidationResult();
